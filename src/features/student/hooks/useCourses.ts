...
const MOCK_COURSES: Course[] = [
  {
    ...
    difficulty: 'beginner',
    teacher: { id: 't1', name: 'Prof. Uwimana', avatarUrl: '', bio: 'Mathematics teacher with 10 years experience', schoolId: 'school-1', schoolName: 'Paysannat Main Campus', courseCount: 5 },
    isPublic: true,
    schoolId: null,
    studentCount: 245,
    rating: 4.5,
  ...
  },
  {
    ...
    category: 'science',
    difficulty: 'beginner',
    teacher: { id: 't2', name: 'Dr. Mugabo', avatarUrl: '', bio: 'Biology specialist', schoolId: 'school-1', schoolName: 'Paysannat Main Campus', courseCount: 3 },
    isPublic: true,
    schoolId: null,
    studentCount: 189,
    rating: 4.7,
  ...
  },
  {
    ...
    teacher: { id: 't3', name: 'Mrs. Nyirahabimana', avatarUrl: '', bio: 'English language instructor', schoolId: 'school-2', schoolName: 'Paysannat Eastern', courseCount: 4 },
    isPublic: true,
    schoolId: null,
    studentCount: 312,
    rating: 4.3,
  ...
  },
  {
    ...
    category: 'science',
    difficulty: 'advanced',
    teacher: { id: 't1', name: 'Prof. Uwimana', avatarUrl: '', schoolId: 'school-1', schoolName: 'Paysannat Main Campus', courseCount: 5 },
    isPublic: false,
    schoolId: 'school-1',
    studentCount: 67,
    rating: 4.8,
  ...
  },
  {
    ...
    difficulty: 'beginner',
    teacher: { id: 't4', name: 'Mr. Habimana', avatarUrl: '', bio: 'Agricultural expert', schoolId: 'school-2', schoolName: 'Paysannat Eastern', courseCount: 2 },
    isPublic: false,
    schoolId: 'school-2',
    studentCount: 156,
    rating: 4.6,
  ...
  },
  {
    ...
    category: 'technology',
    difficulty: 'beginner',
    teacher: { id: 't5', name: 'Mr. Niyonzima', avatarUrl: '', schoolId: 'school-1', schoolName: 'Paysannat Main Campus', courseCount: 3 },
    isPublic: true,
    schoolId: null,
    studentCount: 423,
    rating: 4.4,
  ...
  },
  {
    ...
    category: 'languages',
    difficulty: 'intermediate',
    teacher: { id: 't6', name: 'Mme. Mukamana', avatarUrl: '', schoolId: 'school-1', schoolName: 'Paysannat Main Campus', courseCount: 2 },
    isPublic: false,
    schoolId: 'school-1',
    studentCount: 89,
    rating: 4.9,
  ...
  },
  {
    ...
    category: 'health',
    difficulty: 'beginner',
    teacher: { id: 't7', name: 'Dr. Ingabire', avatarUrl: '', bio: 'Public health specialist', schoolId: 'school-2', schoolName: 'Paysannat Eastern', courseCount: 2 },
    isPublic: true,
    schoolId: null,
    studentCount: 278,
    rating: 4.5,
